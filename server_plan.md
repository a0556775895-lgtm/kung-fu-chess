...
| E — Matchmaking + Disconnect | בביצוע — E1–E3 הושלמו ואושרו; E4 ממתין | Session tokens, שידוך לפי דירוג ו־reconnect שרתי בחלון 20 שניות מומשו. בזמן ניתוק המשחק מושהה, ובתום החלון נרשם הפסד `DISCONNECT`. נותרו reconnect אוטומטי ותצוגת countdown בצד הלקוחה ובדיקות E2E של הזרימה הגרפית |
