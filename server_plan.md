...
| B3.3 — לולאת tick וסנכרון | מומש וממתין לאישור | TickLoop שרתי יחיד מודד זמן מונוטוני אמיתי, שומר שברי מילישנייה, מחלק עיכוב לצעדים ומקדם את כל ה-Match-ים; ARRIVAL ו-STATE סופי נבדקו דרך WebSocket; כל 189 הבדיקות עוברות |
