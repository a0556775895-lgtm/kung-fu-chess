...
WELCOME_IMAGE_PATH = ASSET_ROOT / "welcome_page.png"
LOBBY_MENU_IMAGE_PATH = ASSET_ROOT / "menu.png"
JOIN_ROOM_IMAGE_PATH = ASSET_ROOT / "join_room_menu.png"
ROOM_CREATED_IMAGE_PATH = (
    ASSET_ROOT / "room_created_messege.png"
)
WAITING_ANIMATION_ROOT = ASSET_ROOT / "waiting_animation"

ASSETS_ROOT = ASSET_ROOT / "pieces"
BOARD_IMAGE_PATH = ASSET_ROOT / "board.png"
BACKGROUND_IMAGE_PATH = ASSET_ROOT / "background.png"
SIDE_PANEL_IMAGE_PATH = ASSET_ROOT / "side_panel.png"
GAME_OVER_WHITE_WIN_IMAGE_PATH = (
    ASSET_ROOT / "game_over_white_win.png"
)
GAME_OVER_BLACK_WIN_IMAGE_PATH = (
    ASSET_ROOT / "game_over_black_win.png"
)
...
HIGHLIGHT_IMAGE_PATH = ASSET_ROOT / "highlight.png"
