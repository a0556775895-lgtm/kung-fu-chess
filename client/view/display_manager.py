...
from client.input.mouse_command_extractor import MouseCommandExtractor
from client.input.commands import GameCommandSender
from . import config
...
class DisplayManager:
    ...
    def __init__(
        ...
        *,
        ...
        """Build the multiplayer view from injected client-side services."""
        if board is None or game_engine is None:
        ...
        self._starts_game = False if starts_game is None else starts_game
