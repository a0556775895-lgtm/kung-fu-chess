...
from networking.events import GameStarted
...
from networking.serializers.snapshot_serializer import (
...
from DOCS.tests.texttests.script_parser import ScriptParseError, parse_script
...
@pytest.mark.parametrize("payload", [
    ...
    },
    {
        ...
        "piece": {"id": "p", "kind": "P", "color": "w", "state": "AIRBORNE"},
        "duration_ms": True,
    },
])
def test_network_event_adapter_rejects_non_integer_duration(payload):
