...
from networking.models.piece import PieceState
from server.realtime.real_time_arbiter import RealTimeArbiter
from server.rules.rule_engine import RuleEngine
from server.rules import piece_rules
from networking.models.snapshot import GameSnapshot, MotionSnapshot, PieceSnapshot
...
class GameEngine:
    ...
    def subscribe(self, observer):
        ...
        cancellations = [
            ...
            self._bus.subscribe(JumpStarted, lambda e: observer.on_jump_started(
                e.piece, e.position, e.duration_ms)),
    ...
    def request_jump(self, source):
        ...
        self._bus.publish(JumpStarted(
            piece,
            source,
            piece_rules.get_airborne_duration(),
        ))
